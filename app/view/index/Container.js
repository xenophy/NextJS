...
Ext.define('Docs.view.index.Container', {
    ...
    initComponent: function() {
        ...
        var tpl = new Ext.XTemplate(
            ...
            '<h2>動作環境</h2>',
            '<p>',
                'Next JS は、以下の動作環境をサポートします。',
                'また、次々開発が進む中、利用者からの報告もお待ちしております。',
                '基本的に、nodeが動作する環境であれば動作しますが、Windows版の対応は現在行っておりません。',
            '</p>',
            '<ul>',
                '<li><em>Mac OS X v10.6</em>Snow Leopard</li>',
                '<li><em>Mac OS X v10.7</em>Lion</li>',
                '<li><em>Cent OS 6</em></li>',
                '<li><em>Scientifix Linux 6</em></li>',
                '<li><em>Ubuntu 11.04</em></li>',
            '</ul>',
