...
module.exports = {
    ...
    'test scopeaction#subdir1/index': function(beforeExit) {
        ...
        var file = fs.readFileSync(docRoot + '/public_html/subdir1/index.result.html').toString();
        var req = {
            url: '/subdir1/',
            method: 'GET'
        };
    ...
    'test scopeaction#subdir1/override/index': function(beforeExit) {
        ...
        var file = fs.readFileSync(docRoot + '/public_html/subdir1/override/index.result.html').toString();
        var req = {
