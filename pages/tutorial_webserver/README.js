Ext.data.JsonP.tutorial_webserver({
    "guide": [
        ...
        '<h2>ポートと受付アドレスの設定</h2>',
        '<p>',
        '何かと、設定がたくさんありますが、まず設定することが多そうな、ポートと受付アドレスの設定を行って見ましょう。',
        'ポート番号については、0-1024(WELL KNOWN PORT NUMBER)で起動する場合、root権限が必要な場合がほとんどですので、注意しましょう。',
        '</p>',

        '<pre>',
        'require(<span style="color:#009900;">\'nx\'</span>).service({' + "\n",
        '    port: <span style="color:#009900;">80</span>,' + "\n",
        '    host: <span style="color:#009900;">\'127.0.0.1\'</span>' + "\n",
        '});',
        '</pre>',

        '<p>',
        'こうすると、80ポートでリスンして、ローカルからのアクセスのみを許可する用になります。',
        'アクセスを制限する場合には、このようにhostを利用してアクセス制限を行えます。',
        '環境にもよりますが、80ポートはApacheや場合によっては、Skypeなどでリスンされている可能性があります。',
        '既にリスンされているポートは利用できませんので、ご注意ください。',
        '</p>',


        '<h2>公開ディレクトリを変更する</h2>',
        '<p>',
        'デフォルトでは、nodeコマンドを実行したディレクトリの<em>public</em>というディレクトリが',
        '公開ディレクトリになります。',
        '</p>',
        '<p>',
        'どこでnodeコマンドを実行しても固定化させるためには、フルパスを指定してください。',
        '</p>',

        '<pre>',
        'require(<span style="color:#009900;">\'nx\'</span>).service({' + "\n",
        '    paths: {' + "\n",
        '        <span style="color:#000099;">public</span>: <span style="color:#009900;">\'/home/www/public/\'</span>' + "\n",
        '    }' + "\n",
        '});',
        '</pre>',
        ...
        '<h2>ログを出力させる</h2>',
        '<p>',
        'ログの詳しい設定方法については、ロギングの項目で説明しますが、',
        'ここでは、簡単にログを出力するための設定を行います。',
        '</p>',
        '<p>',
        '設定というよりも、ただディレクトリを作成することで出力されるようになります。',
        'server.jsのあるディレクトリに<em>logs</em>というディレクトリを作成することで',
        '<em>access_log</em>と<em>error_log</em>を出力するようになります。',
        '</p>',

        '<pre>',
        '127.0.0.1 03/09/2011:04:59:03 +0900 "GET / HTTP/1.1" 200 195',
        '</pre>',
