...
var $METHOD = module.exports = function(classes, existCache, parseNamespace, namespaceRewrites, className) {
    ...
    if(classes.hasOwnProperty(className) || existCache.hasOwnProperty(className)) {
        return true;
    }

    root = global;
    parts = parseNamespace(namespaceRewrites, className);
