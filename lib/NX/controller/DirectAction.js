...
NX.DirectAction = function() {
    ...
    NX.apply(me, {
        ...
        parseModules : function(action, use, mods, modroot, callback) {
            ...
            NX.each(use, function(mod, i) {
                ...
                if(!mods[name]) {
                    ...
                    var err = new Error(NX.sprintf('module: %s is not found.', name));
                    callback(err);
                    return;
                }
    ...
    return NX.extend(NX.Action, {
        ...
        execute : function(req, res) {
            ...
            if(req.method === "POST") {
                ...
                // モジュール解析
                parseModules(me, me.use, me.controller.__modules, me.controller.modulePath, function(err, api) {
