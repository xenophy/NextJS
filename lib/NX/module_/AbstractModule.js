...
var truncate = require('./abstract/truncate');
var find = require('./abstract/find');
var lock = require('./abstract/lock');
var unlock = require('./abstract/unlock');
var set = require('./abstract/set');
...
NX.module.AbstractModule = NX.extend(require('events').EventEmitter, {
     ...
     * @method find
     */
    find : function(type, cond, callback) {
        find(this, type, cond, callback);
    },
     ...
     * @method lock
     */
    lock : function(tables, callback) {
        lock(this, tables, callback);
    },
     ...
     * @method set
     */
    set : function(data, cond, callback) {
        set(this, data, cond, callback);
    },
