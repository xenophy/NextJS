...
NX.define('NX.view.Web', {
    ...
    constructor: function(paths, req, res) {
    ...
    loadFile: function(file, callback) {
        ...
        (function(file, callback) {
            ...
            // テンプレートファイル確認
            NX.Path.exists(tpl, function(exists) {
    ...
    render: function(info) {
        ...
        me.loadFile(me.paths.template, function(err, data, stat) {
        ...
        (function(tpl, req, res, favicon) {
            ...
            NX.Path.exists(tpl, function(exists) {
                ...
                if(!exists) {
                    ...
                    NX.Fs.stat(tpl, function(err, stat) {
                        ...
                        NX.Fs.readFile(tpl, function(err, data) {
                            ...
                            // テンプレート拡張子の場合は、テンプレート処理




                            var headers = {
                                "Content-Type": me.mimetype[NX.Path.extname(me.paths.template).substr(1)] + '; charset=utf-8' ,
        ...
        })(me.paths.template, req, res, me.favicon);
        */
