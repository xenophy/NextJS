...
NX.module.adapter.MySQL = NX.extend(NX.module.adapter.AbstractAdapter, {
     ...
     */
    getQueryBeginTrans : function(table) {
        return getQueryBeginTrans(this, table);
    },
     ...
     */
    getQueryRollback : function(table) {
        return getQueryRollback(this, table);
    },
     ...
     */
    getQueryCommit : function(table) {
        return getQueryCommit(this, table);
    },
